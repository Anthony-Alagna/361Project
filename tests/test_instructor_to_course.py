...
class AddInstructorsToCourse(TestCase):
    ...
    def test_add_blank_user_to_course(self):
        ...
        course = Supervisor.removeInstructorFromClass(course.Course_Instructor, course_code=course.Course_Code)
        print(course.Course_Instructor)
    ...
    def test_remove_blank_instructor(self):
        ...
        self.assertEqual(res.Course_Instructor,"", "nothing to remove since it is blank")
