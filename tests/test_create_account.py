...
# Method: Supervisor.createAccount(fName: str, lName: str, email: str, username: str, password: str, address: str, city: str, phone: str, account_type: str)
class CreateAccountTest(TestCase):
    ...
    def test_create_account_username_exists(self):
        result = Supervisor.createAccount("Michael", "Scott", "mscott@uwm.edu", "mscott", "password", "123 Oakland Ave",
                                          "Milwaukee", "4144165289", "Instructor")
        self.assertNotEqual(result, User.objects.filter(username="mscott"),
