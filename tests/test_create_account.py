...
class create_accountTest(TestCase):
    ...
    def test_create_account_successful(self):
        result = Supervisor.create_account("Michael", "Scott", "mscott@uwm.edu", "mscott", "password",
                                           "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
        self.assertEqual(result, User.objects.get(User_LogName="mscott"), "Created account not found in database")

    # doesn't add user to the database if username already exists
    def test_create_account_username_exists(self):
        self.user1 = User.objects.create(User_fName='Michael', User_lName="Scott",
                                         User_Email='mscott@uwm.edu',
                                         User_Pos='Instructor', User_Phone='1234567890',
                                         User_Address='123 Main St', User_City="Milwaukee",
                                         User_LogName='agentscarn', User_LogPass='password',
                                         User_begin='2022-01-01 00:00:00', User_Updated='2023-04-18 00:00:00')

        result = Supervisor.create_account("Michael", "Scott", "mscott@uwm.edu", "agentscarn", "password",
                                           "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
        self.assertNotEqual(result, User.objects.get(User_LogName="agentscarn"),
    ...
    def test_create_account_field_fname_missing(self):
        result = Supervisor.create_account("", "Scott", "mscott@uwm.edu", "mscott", "password", "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
    ...
    def test_create_account_field_lname_missing(self):
        result = Supervisor.create_account("Michael", "", "mscott@uwm.edu", "mscott", "password", "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
        self.assertNotEqual(result, User.objects.filter(User_LogName="mscott"),
                            "Account should not have been created, last name missing")

    def test_create_account_field_email_missing(self):
        result = Supervisor.create_account("Michael", "Scott", "", "mscott", "password", "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
        self.assertNotEqual(result, User.objects.filter(User_LogName="mscott"),
                            "Account should not have been created, email missing")

    def test_create_account_field_username_missing(self):
        result = Supervisor.create_account("Michael", "Scott", "mscott@uwm.edu", "", "password", "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
    ...
    def test_create_account_field_password_missing(self):
        result = Supervisor.create_account("Michael", "Scott", "mscott@uwm.edu", "mscott", "", "123 Oakland Ave",
                                           "Milwaukee", "4144165289", "Instructor")
        self.assertNotEqual(result, User.objects.filter(User_LogName="mscott"),
