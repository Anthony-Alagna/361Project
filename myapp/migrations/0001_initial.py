...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Course',
            fields=[
                ('id', models.AutoField(default=0, primary_key=True, serialize=False, unique=True, verbose_name='course_id')),
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('id', models.AutoField(default=0, primary_key=True, serialize=False, unique=True, verbose_name='user_id')),
        ...
        migrations.CreateModel(
            name='Section',
            fields=[
                ('id', models.AutoField(default=0, primary_key=True, serialize=False, unique=True, verbose_name='section_id')),
